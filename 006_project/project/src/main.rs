...
fn main(){
    ...
    println!("The season is: {0}, the points scored on this is {1}, the event time: {2} and the TOUCHDOWN_POINTS is: {3}", season, points_scored, event_time, TOUCHDOWN_POINTS);
